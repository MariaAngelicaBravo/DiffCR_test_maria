...
input_root  = Path("/mnt/compartida/mbravo_cps/DOCTORADO/DiffCR_results/data/FUSED_IMAGES_NEW")
output_root = Path("/mnt/compartida/mbravo_cps/DOCTORADO/DiffCR_results/data/FUSED_IMAGES_NEW_PNG")
...
for tile in input_root.iterdir():
    ...
    save_dir = output_root / tile.name
    save_dir.mkdir(parents=True, exist_ok=True)

    for tif_file in tile.glob("*.tif"):
