...
class Sen2_MTC_New_Multi(data.Dataset):
    ...
    def __init__(self, data_root, mode='train'):
        ...
        for tile in tile_list:
            ...
            image_names = [
                f.split('.tif')[0] for f in os.listdir(cloudless_dir)
                if f.endswith('.tif')
            ]
            ...
            for name in image_names:
                ...
                cloud0 = os.path.join(cloud_dir, f"{tile}_{base}_0.tif")
                cloud1 = os.path.join(cloud_dir, f"{tile}_{base}_1.tif")
                cloud2 = os.path.join(cloud_dir, f"{tile}_{base}_fused.tif")

                cloudless = os.path.join(cloudless_dir, f"{tile}_{base}.tif")

                if os.path.exists(cloud0) and os.path.exists(cloud1) and os.path.exists(cloud2):
                    ...
                    self.image_name.append(f"{tile}_{base}")
